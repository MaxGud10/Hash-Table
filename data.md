...
**Среднее значение:**
$$ \bar{t} = 8.1684 \cdot 10^{10} \text{ циклов} $$

**Стандартное отклонение:**
$$ \sigma = \sqrt{\frac{\sum_{i=1}^{15} (t_i - \bar{t})^2}{15}} \approx 3.24 \cdot 10^{8} \text{ циклов} $$

**Случайная погрешность:**
$$ \Delta t = 2.145 \cdot \frac{3.24 \cdot 10^8}{\sqrt{15}} \approx 1.79 \cdot 10^{8} \text{ циклов} $$

**Итоговый результат:**
$$ (8.1684 \pm 0.0179) \cdot 10^{10} \text{ циклов} $$
